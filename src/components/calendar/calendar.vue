<template>
  <div class="mu-calendar">
    <div class="mu-calendar-header">
      <div class="mu-calendar-title" @tap="onTitleClick">
        {{ title }}
      </div>
      <icon-button button-style="link" icon="key-up" @tap="goPrev" />
      <icon-button button-style="link" icon="calendar" @tap="goNow" />
      <icon-button button-style="link" icon="key-down" @tap="goNext" />
    </div>
